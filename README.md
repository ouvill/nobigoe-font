...
源暎こぶり明朝と同じく、白ハート `♡`（U+2661）と黒ハート `♥`（U+2665）に結合濁点を続けた2列も一体字形へ置換します。私用領域の基字U+E064・U+E065でも同じ結合が働き、完成字形はそれぞれU+E0DC・U+E0DDで直接入力できます。ハートはNoto Serif JPの輪郭を使用し、濁点の2画を源暎こぶり明朝の配置比率に合わせて個別に配置しています。

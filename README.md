...
- 感嘆符・疑問符とその合字を、明朝・斜体明朝・ゴシック・斜体ゴシックから選択
- Manga1方式のルビ字形と、小書きこ`𛄲`・小書きコ`𛅕`を収録
...
のびごえ明朝はNoto Serif JPの和文とLibertinus Serifの欧文を組み合わせています。のびごえこぶり明朝は源暎こぶり明朝を土台にした独立ファミリーです。どちらも同じ追加機能とUnicode入力を利用できます。
...
| `ss02` | 全角感嘆符・疑問符と合字をゴシックへ変更 |
| `ss03` | 全角感嘆符・疑問符と合字を斜体ゴシックへ変更 |
| `ss04` | 連続する`〜`・`～`を、よりゆるやかな波形へ変更 |
| `ruby` | 対応するかな、数字、約物、半濁点付き仮名をルビ字形へ変更 |

CSSで斜体ゴシックとゆるやかな波形を有効にする例:
